...
/// <summary>
/// Tests for PairHeap to verify insert, find-min, extract-min, and decrease-key behavior.
/// Author: Christian Lindner, calindner@crimson.ua.edu
///         Brock Kitterman, bfkitterman@crimson.ua.edu
/// </summary>
public static class PairHeapTest
{
    /// <summary>
    /// Run all Pair heap unit tests and print results.
    /// </summary>
    public static void Run()
    {
        Console.WriteLine("=== Pair Heap Tests ===");
        var testNumber = 0;
        var passed = 0;
        var failed = 0;
